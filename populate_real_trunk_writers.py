"""
Populate Weekend Trunk Writer application with actual employee names from WEEKEND TRUNKWRITER ROTATION
"""
import json
...
print(f"\nFirst 5 employees (sorted alphabetically by last name):")
